          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12 lg:gap-24 items-center">
            ...
            <div>
              ...
              <h2 className="text-[clamp(22px,2.5vw,32px)] leading-relaxed text-[#111827] font-bold mb-8">
                I'm a final-year BCA student at St. Aloysius learning <span className="text-[#f472b6] font-black underline decoration-4 underline-offset-4 pointer-events-none">Spring Boots</span> and working on projects while letting <span className="text-[#60a5fa] font-black underline decoration-4 underline-offset-4 pointer-events-none">Antigravity AI handle the React.</span> I started off writing basic Servlets and JDBC until I realized saving time is better than <motion.span whileHover={{ scale: 1.1, rotate: -5 }} className="bg-[#fde047] px-2 py-1 rounded-md border-4 border-[#111827] shadow-[4px_4px_0px_0px_#111827] inline-block cursor-pointer mx-1 active:translate-y-1 active:shadow-none transition-shadow">suffering.</motion.span>
              </h2>
